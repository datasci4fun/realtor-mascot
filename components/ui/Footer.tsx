...
export function Footer() {
  ...
  const socialLinks = [
    { name: 'Twitter', href: settings.twitter_url, icon: <TwitterIcon /> },
    { name: 'Facebook', href: settings.facebook_url, icon: <FacebookIcon /> },
    { name: 'Instagram', href: settings.instagram_url, icon: <InstagramIcon /> },
    { name: 'LinkedIn', href: settings.linkedin_url, icon: <LinkedInIcon /> },
    { name: 'YouTube', href: settings.youtube_url, icon: <YouTubeIcon /> },
  ].filter(social => social.href) // Only show links that are configured
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 leading-relaxed max-w-md mb-6">
              {settings.site_description || 'The Original Buyer Broker in Texas. Helping buyers save time, effort, and money across the Dallas-Fort Worth metroplex since 2005.'}
            </p>
            ...
            <ul className="space-y-4">
              <li>
                ...
                >
                  ...
                  <span>{settings.realtor_phone}</span>
                </a>
              </li>
              <li>
                <a
                ...
                >
                  ...
                  <span className="text-sm">{settings.realtor_email}</span>
                </a>
              </li>
              <li className="flex items-center gap-3 text-gray-400">
                ...
                <span>{settings.service_areas || 'Dallas-Fort Worth Metroplex'}</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-500 text-sm">
              &copy; {new Date().getFullYear()} {settings.brokerage_name || 'Artistic Real Estate Group'}. All rights reserved.
            </p>
            <div className="flex items-center gap-2 text-sm">
              <span className="w-2 h-2 bg-green-500 rounded-full animate-pulse" />
              <span className="text-gray-400">{settings.realtor_name}{settings.realtor_title ? `, ${settings.realtor_title}` : ''}</span>
            </div>
          </div>
        </div>
      </div>
